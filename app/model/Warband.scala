...
sealed trait MemberType(val startingTraits: Int) {
    abstract def create(implicit traitLookup: Map[String, MemberTrait]): Member
}
...
case class Faction(name: String, description: String, rivalFactionName: String, aliases: Map[MemberType, String], trait: Trait)
